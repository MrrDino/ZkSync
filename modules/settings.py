...
EXCHANGES_STATUS = {
    ...
    'liq': {
        # включено ли добавление ликвидности
        'Mute': True,
        'Izumi': False,
        'SpaceFi': False,
        'Velocore': True,
...
# Обмен токенов
NEED_SWAP = False
SWAP_BACK = False  # нужно ли производить обратный свап
...
NEED_NFT = False  # включен ли модуль NFT


# Покупка шиткоинов
NEED_SHITCOIN = False  # включен ли модуль покупки шиткоинов

AMOUNTS = {
    0: (0.0040783968, 0.005646994),  # сумма обмена токенов в ETH
    1: (50, 250),  # сумма добавления ликвидности в центах
    2: (0.001, 0.002)  # сумма покупки шиткоинов в ETH
}
